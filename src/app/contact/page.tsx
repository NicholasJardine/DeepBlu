...
//       <Header onServicesClick={handleScrollToServices} />
//       <section className="py-10 flex flex-col items-center bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_86%)] overflow-x-clip shadow-md">
//         <h1 className="section-title text-5xl sm:text-6xl md:text-7xl mb-4 text-center">
//           Get in Touch
//         </h1>
//         <div className="bg-white w-[90%] sm:w-[85%] md:max-w-[75%] lg:max-w-[75%] xl:max-w-[75%] rounded-lg shadow-lg overflow-hidden mb-16">
//           <div className="flex flex-col md:flex-row items-stretch justify-between gap-10 p-8">
...
//           Get in Touch
//         </h1>
//         <div className="bg-white max-w-[75%] md:max-w-[75%] lg:max-w-[65%] w-[90%] sm:w-[85%] rounded-lg shadow-lg overflow-hidden mb-16">
//           <div className="mx-auto max-w-[90%] flex flex-col md:flex-row items-stretch justify-between gap-10 p-8">
//             {/* Contact Info Section */}
//             <div className="basis-full md:basis-[48%] text-[#676767]">
//               <h3 className="font-medium text-[#000F38] text-[25px] flex items-center mb-5">
  ...
  return (
    <>
      ...
      <section className="py-10 flex flex-col items-center bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_86%)] overflow-x-clip shadow-md">
        ...
        <div className="bg-white w-[90%] sm:w-[85%] md:max-w-[75%] lg:max-w-[65%] xl:max-w-[75%] rounded-lg shadow-lg overflow-hidden mb-16">
          <div className="mx-auto max-w-[90%] flex flex-col md:flex-row items-stretch justify-between gap-10 p-8">
            {/* Contact Info Section */}
            <div className="basis-full md:basis-[48%] text-[#676767]">
              <h3 className="font-medium text-[#000F38] text-[25px] flex items-center mb-5">
